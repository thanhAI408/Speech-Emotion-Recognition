#cach chay: streamlit run app.py
...
def load_LSTM_model():
    ...
    return load_model("LSTM_model_Date_Time_2025_06_20_23_55_00___Loss_0.043416813015937805___Accuracy_0.9861111044883728.h5")
...
def predict(model, wav_filepath):
    ...
    # 1 - bình thường, 2 - điềm tĩnh, 3 - vui vẻ, 4 - buồn, 5 - tức giận, 
    # 6 - sợ hãi, 7 - ghê tởm, 8 - ngạc nhiên
...
def main():
    ...
    st.image('image.jpg')  # Displaying an image
